...
"shortdesc": ""},
{"file": "8b3ae43c47024c888c6b2e5c3d94cb25.html",
"title": "image_map_test_1",
"shortdesc": "This event is published after a job information change for an individual contributor that has been assigned a new direct report. The new manager's assignment is passed on to subscribers, that will receive information as of the effective start date."},
...
"shortdesc": "SPLASH users can make their projects available on the Gallery page for viewing and cloning by other SPLASH users. You may clone a project because you want to use only a single page or single project asset, or because you want to use entire prototype, it's up to you. For more information see the link below."},
{"file": "821343eec86945f0b01980286f1fcdb2.html",
"title": "Prototype Pages",
"shortdesc": "Create realistic and interactive prototype pages in the Prototype tool with the User Interface (UI) Editor. Defines your data model in the Data Editor."},
...
"title": "Toolbar",
"shortdesc": "The UI Editor toolbar includes various options to customize your prototype and canvas view."},
...
"shortdesc": "The UI Editor in the Prototype tool lets you quickly create split-screen layout Master Detail pages. These pages include two structured pages with built-in navigation. One page displays a list of selectable items (master list). The second page displays the details of the selected item (details area)."},
...
"shortdesc": "SAP Web IDE is a browser-based development tool that helps you create and extend end user applications for browser and mobile devices.Web IDE simplifies the end-to-end application life cycle: development, packaging, deployment, and customer extensions for SAPUI5 applications.BUILD generates the code that you can import into Web IDE as a starting point for developers. The same code that is generated for your BUILD prototype, used in previewed and published applications, can be imported into SAP Web IDE using the BUILD plugin. This can then be used as a starting point for developers, to add additional logic to the design and to connect to the existing oData services. You can use Web IDE to connect to the existing backend services, and you can see data from the server."},
...
"title": "Access Learning and Community Pages",
"shortdesc": "The Learning and Community pages provide educational support, e-learning materials, and an interactive space where you can actively participate and interact with user experience design experts. SPLASH Users with no background in user experience design can use these resources and apply their knowledge to their app development."},
{"file": "756c0abf4ad74ae7999cc937b0911b7c.html",
"title": "Learning Page Overview",
"shortdesc": "The Learning center supports Splash users by providing them with educational tools regarding the fundamentals of user experience design. You can access the content there to learn more about common user experience design practices through methods, design services, and courses."},
{"file": "3d9fea37998f4260bcd2b0b741b64faf.html",
"title": "Community Page Overview",
"shortdesc": "The Community page is an internal community where SPLASH users can view, search, and participate in topics related to SPLASH and user experience design. Each forum is divided into topics, where you can find and share information and resources on a specific subject."},
{"file": "8c60b9804ac1441c81b2b68315e419e8.html",
"title": "Access Topics",
"shortdesc": "Each forum displays a list of topics that SPLASH users create. You can view the details of each topic by selecting a forum from the Community page."},
{"file": "103b8b6eedf842db87c6551f2f39c211.html",
"title": "Create, Edit, and Delete Topics",
"shortdesc": "Create a topic in any of the Community forums to start a discussion."},
{"file": "06ee1a4f115144cb90c9b7d671abe5a3.html",
"title": "Enterprise Page Overview",
"shortdesc": "SPLASH for your Enterprise is a personalized version of SPLASH which you can customize for your organization. You can manage your own private gallery, choose which learning content you want made available, set your own design guidelines, and decide on your own project management."},
